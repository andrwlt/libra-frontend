...
export default function ConnectAccountButton() {
  ...
  return (
    <>
      {account ? (
        <Button shape="round" block onClick={() => setOpen(true)} style={{ padding: '0px 32px' }}>
          <Space align="center">
        ...
        <Button shape="round" loading={!isReady || connecting} block type="primary" onClick={handleConnectExtension}>
          Connect wallet
        </Button>
      )}
