const en = {
  ...
  congratulationContent: `Every great journey begins with a single step. Your checkout is now ready, and you're all set to collect your first cryptocurrency payment`,
  ...
  connectWalletTitle: `Securely Connect Your Wallet`,
  connectWalletContent: `To create your account and log in to our system, please connect your wallet. All revenue collected will be directly sent to this wallet with zero transaction fees.`,
  connectWalletHighlight: `Rest assured, we will never sign any transactions without your authorization. Your wallet is secure, and we do not store any of your personal information.`,
